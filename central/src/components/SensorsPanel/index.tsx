      ...
      <Grid templateColumns="1fr 1fr 1fr" gap={8}>
        <GridItem>
          <StatsDisplay
            ...
            info={
              deviceStatus('sensors.windows.room1') ? 'Ligado' : 'Desligado'
            }
            icon={GiWindow}
            isLoaded={
              typeof deviceStatus('sensors.windows.room1') === 'boolean'
            }
          />
        </GridItem>
        ...
        <GridItem>
          <StatsDisplay
            ...
            info={
              deviceStatus('sensors.windows.room2') ? 'Ligado' : 'Desligado'
            }
            icon={GiWindow}
            isLoaded={
              typeof deviceStatus('sensors.windows.room2') === 'boolean'
            }
          />
        </GridItem>
